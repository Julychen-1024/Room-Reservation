<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="注册.aspx.cs" Inherits="网上订房.注册" %>
...
<body>
   ...
   <header></header>
    ...
    <div id="container">
        ...
        <tr><td class="auto-style1"></td></tr>
         <tr>
            <td class="auto-style1" style="text-align: right"><asp:Button ID="Button1" runat="server" Text="提交" Height="30px" Width="55px" OnClick="Button1_Click"/></td>
        </tr>
    </table>
        <style>
            table{
