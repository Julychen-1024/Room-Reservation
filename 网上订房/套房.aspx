<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="套房.aspx.cs" Inherits="网上订房.套房" %>
    ...
    <div id="container">
        ...
        <tr><td class="auto-style1"></td></tr>
         <tr>
            ...
            <td><input id="Text1" name="Text1"  type="date" runat="server" /></td>
        ...
        <tr><td class="auto-style1"></td></tr>
         <tr>
            ...
            <td><asp:TextBox ID="TextBox6" runat="server" Text="300" ReadOnly="True"></asp:TextBox></td>
        </tr>
        <tr><td class="auto-style1"></td></tr>
         <tr>
