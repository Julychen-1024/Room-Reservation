<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="标准房.aspx.cs" Inherits="网上订房.标准房" %>
    ...
    <div id="container">
        ...
        <tr><td class="auto-style1"></td></tr>
         <tr>
            ...
            <td><input type="date" id="TextBox4" name="TextBox4" runat="server"/></td>
        </tr>
        <tr><td class="auto-style1"></td></tr>
         <tr>
        ...
        <tr><td class="auto-style1"></td></tr>
         <tr>
            ...
            <td><asp:TextBox ID="TextBox6" runat="server" ReadOnly="True" OnTextChanged="TextBox6_TextChanged" Text="120"></asp:TextBox></td>
        </tr>
        <tr><td class="auto-style1"></td></tr>
         <tr>
